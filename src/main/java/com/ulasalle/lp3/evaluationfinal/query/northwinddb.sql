...
--
/*
Northwind es una base de datos de pruebas que representa la base de datos de una empresa comercial y es propiedad de Microsoft,
compañia que permite su uso entre los interesados en aprender sql. En este video, aprenderás a cargar Northwind en postgres.
*/
---
